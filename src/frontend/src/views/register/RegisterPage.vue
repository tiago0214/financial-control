              ...
              <div class="flex flex-col gap-1">
                <div class="relative">
                  ...
                  <InputText
                    ...
                    :pt="{
                      root: `!w-full !rounded-xl !border !bg-input/50 !py-3 !pl-11 !pr-4 !text-sm transition-all placeholder:!text-muted-foreground focus:!outline-none focus:!ring-2 ${$form.name?.invalid ? '!border-red-400 focus:!border-red-500 focus:!ring-red-500/20' : '!border-border focus:!border-primary focus:!ring-primary/20'}`,
                    }"
                  />
                </div>
                <Message
              ...
              <div class="flex flex-col gap-1">
                <div class="relative">
                  ...
                  <InputText
                    ...
                    :pt="{
                      root: `!w-full !rounded-xl !border !bg-input/50 !py-3 !pl-11 !pr-4 !text-sm transition-all placeholder:!text-muted-foreground focus:!outline-none focus:!ring-2 ${$form.confirmPassword?.invalid ? '!border-red-400 focus:!border-red-500 focus:!ring-red-500/20' : '!border-border focus:!border-primary focus:!ring-primary/20'}`,
                    }"
                  />
                </div>
                <Message
