     ...
     <!-- Formulário de Nova Transação -->
      <form class="space-y-5" @submit.prevent="handleSubmit">
        ...
        <div class="flex flex-col gap-1.5">
          ...
          <input v-model="description" required type="text" class="w-full outline-0 bg-background border border-border focus:border-primary focus:ring-1 focus:ring-primary rounded-xl px-4 py-2.5 text-sm transition-all" placeholder="Ex: Compra no supermercado" />
        </div>
        ...
        <div class="grid grid-cols-2 gap-4">
          <div class="flex flex-col gap-1.5">
            ...
            <input v-model="amount" required type="number" step="0.01" class="w-full outline-0 bg-background border border-border focus:border-primary focus:ring-1 focus:ring-primary rounded-xl px-4 py-2.5 text-sm transition-all" placeholder="0.00" />
          </div>
          <div class="flex flex-col gap-1.5">
            <label class="text-sm font-semibold text-foreground">Data</label>
            <input v-model="date" required type="date" class="w-full outline-0 bg-background border border-border focus:border-primary focus:ring-1 focus:ring-primary rounded-xl px-4 py-2.5 text-sm transition-all text-muted-foreground" />
          </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          <div class="flex flex-col gap-1.5">
            ...
            <select v-model="status" class="w-full outline-0 bg-background border border-border focus:border-primary focus:ring-1 focus:ring-primary rounded-xl px-4 py-2.5 text-sm transition-all cursor-pointer">
        ...
        <div class="flex flex-col gap-1.5">
          ...
          <select v-model="paymentMethod" class="w-full outline-0 bg-background border border-border focus:border-primary focus:ring-1 focus:ring-primary rounded-xl px-4 py-2.5 text-sm transition-all cursor-pointer">
